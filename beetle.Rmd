...
2) Average GDD values across the period the showns, across all GCMs
...
Calculate GDD sum across beetle development year - 1 August - 31 July, Following @buotteClimateInfluencesWhitebark2016
...
Dark grey line shows the GYE boundary, thin blue line shows existing whitebark pine distribution from https://whitebarkfound.org/our-work/national-whitebark-pine-restoration-plan/data/

[Source code]{https://github.com/shuysman/beetle_gdd}

``` {R, fig.height = 14, fig.width = 14, out.width = '100%', warning = FALSE, message = FALSE}
library(terra)
library(tidyterra)
library(ggmap)
library(sf)
...
``` {R beetle-years, fig.height = 3, fig.width = 12, out.width = '100%'}
start_month <- 5
